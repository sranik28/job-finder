...
const FilterdPageCard = ({card}) => {
    const {logo, jobTitle, company, jobType, location, salary,jobTime, _id} = card
            ...
            <div className='md:flex justify-between items-center w-full'>
                ...
                <div>
                    ...
                    <div className='flex gap-2 items-center mt-4 text-[#757575]'>
                        <p className='flex gap-2 items-center'><ImLocation/>{location}</p>
                        <p className='flex gap-2 items-center'><AiOutlineDollarCircle/>{salary}</p>
                    </div>
