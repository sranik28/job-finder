...
import FilterdPageCard from '../components/FilterdPageCard/FilterdPageCard';
    ...
    return (
        <section className=' mt-[140px]'>
            ...
            <div className="block ml-auto dropdown dropdown-bottom relative my-10">
                <label tabIndex={0} className=" block  w-[100px] ml-auto bg-indigo-500 px-5 py-2 text-center rounded-md">
                    Filter
                </label>
                <ul
                    tabIndex={0}
            ...
            {
                jobs.map((card) => <FilterdPageCard key={card._id} card={card} ></FilterdPageCard>)
            }
        </section>
    );
};
